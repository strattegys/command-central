/**
 * Canonical `spec.brief` for template `vibe-coding-outreach` when the client omits `spec.brief`.
 * Keep in sync with docs/working-samples/tim-warm-outreach-campaign-spec.md and the dollar-quoted
 * block in scripts/seed-vibe-coding-warm-outreach-package.sql.
 */
export const TIM_WARM_OUTREACH_PACKAGE_BRIEF = `# Tim — Warm outreach campaign spec (vibe coding / AI agents)
